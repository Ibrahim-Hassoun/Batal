            ...
            child: Column(
              children: [
                ...
                itemBuilder: (context,index){
                  ...
                  return ExerciseRow(title: exerciceData['exercice'], imageUrl: exerciceData['image_url']??'https://images.unsplash.com/photo-1605296867304-46d5465a13f1',initialCount: exerciceData['pivot']['sets'],id: exerciceData['id'],);
                },
                ),
                GestureDetector(
